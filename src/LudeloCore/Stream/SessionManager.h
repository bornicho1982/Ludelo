// Archivo: src/LudeloCore/Stream/SessionManager.h
#pragma once

#include "LudeloCore/Common.h"
#include "LudeloCore/Stream/VideoDecoder.h"
#include "LudeloCore/Stream/AudioDecoder.h"
...
public:
    ...
    VoidResult connect_local(const ludelo::discovery::RegisteredConsole& console, const StreamConfig& config);
    VoidResult connect_cloud(const ludelo::auth::PSNTokens& tokens, const std::string& game_id, const StreamConfig& config);
    void disconnect();
...
private:
    ...
    ludelo::discovery::RegisteredConsole m_console{};
