// Archivo: src/PortalCore/Cloud/CloudCatalog.cpp
...
// ─── fetch_and_cache ────────────────────────────────────
portal::VoidResult CloudCatalog::fetch_and_cache(const std::string& access_token) {
...
portal::VoidResult CloudCatalog::fetch_and_cache(const std::string&) {
